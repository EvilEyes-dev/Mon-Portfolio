    ...
    <section id="hero" className="hero">
      <div className="container">
        <div className="hero-content">
          ...
          Étudiant en Génie Logiciel, je conçois des interfaces utilisateur modernes
          et développe des applications web et mobiles, avec un intérêt particulier 
          pour la sécurité et l'audit informatique.
