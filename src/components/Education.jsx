        ...
        <div className="education-content">
          ...
          <div className="education-item">
            ...
            <p className="education-description">
              Programme intensif couvrant l'ensemble du développement web
              moderne, du front-end au back-end, avec une approche projet et
              pratique.
            </p>
          ...
          <div className="education-item">
            ...
            <p className="education-description">
              Apprentissage continu à travers la réalisation de projets
              personnels et la veille technologique active.
            </p>
