      ...
      <div className="container">
        ...
        <div className="contact-container">
          <p className="contact-intro">
            Je recherche un stage développeur full-stack de <strong>3 à 6 mois</strong> à 
            partir de <strong>Mai 2026</strong>. Disponible pour un entretien ou un 
            échange technique.
          </p>
